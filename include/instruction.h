...
// void handle_sne_vx_nn(SChip8 *Chip8, uint16_t Opcode); // Handles 4XNN
// void handle_se_vx_vy(SChip8 *Chip8, uint16_t Opcode); // Handles 5XY0
// void handle_ld_vx_nn(SChip8 *Chip8, uint16_t Opcode); // Handles 6XNN
// void handle_add_vx_nn(SChip8 *Chip8, uint16_t Opcode); // Handles 7XNN
// void handle_8000(SChip8 *Chip8, uint16_t Opcode); // Sub-switch for arithmetic group 8XY0 - 8XYE
